	...
	bool Client::processMessage()
	{
		...
		else if (lMessageType == "SHOOT")
		{
			...
			if (lDue.remainingMs() < 0) {
				cerr << "Player timed out during SHOOT" << endl;
		...
		else if (lMessageType == "GUESS")
		{
			...
			if (lDue.remainingMs() < 0) {
				cerr << "Player timed out during GUESS" << endl;
		...
		else if (lMessageType == "HIT")
		{
			...
			if (lDue.remainingMs() < 0) {
				cerr << "Player timed out during HIT" << endl;
		...
		else if (lMessageType == "REVEAL")
		{
			...
			if (lDue.remainingMs() < 0) {
				cerr << "Player timed out during REVEAL" << endl;
